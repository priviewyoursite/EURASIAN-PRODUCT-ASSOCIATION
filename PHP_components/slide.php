	  ...
	  <!--Slide 1-->
		...
		<div class="carousel-item absolute opacity-0" style="height:50vh;">
			<div class="block h-full w-full bg-indigo-500 text-white text-5xl text-center">
				<img class="block h-full w-full" wed="max-width=100%" src="../2.jpg">
			</div>
		</div>
		...
		<div class="carousel-item absolute opacity-0" style="height:50vh;">
			<div class="block h-full w-full bg-orange-500 text-gray text-5xl text-center">Slide 2</div>
		</div>
		...
		<div class="carousel-item absolute opacity-0" style="height:50vh;">
			<div class="block h-full w-full bg-green-500 text-white text-5xl text-center">Slide 4</div>
		</div>
